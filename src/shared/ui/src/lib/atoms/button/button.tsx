...
const Button: FC<ButtonProps> = forwardRef((props: ButtonProps, buttonRef) => {
  ...
  const colorsBorder: { [P in BDColors]: string } = {
    ...
    lightGray:
      "border-light-gray-600 text-light-gray-600 transition-all hover:bg-light-gray-600 hover:text-title-light",
  ...
  const colorsLink: { [P in BDColors]: string } = {
    ...
    secondary:
      "text-button-secondary underline transition-all hover:text-button-secondaryAlt",
    primary:
      "text-button-primary underline transition-all hover:text-button-primaryAlt",
    lightGray:
      "text-light-gray-500 underline transition-all hover:text-light-gray-600",
    ghostBlue:
      "text-ghost-blue-500 underline transition-all hover:text-ghost-blue-600",
