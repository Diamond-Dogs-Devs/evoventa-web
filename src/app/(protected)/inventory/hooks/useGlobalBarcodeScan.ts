 ...
 * tenga el foco en ese momento — normalmente el buscador, que es un
 * <input>. Antes este hook ignoraba por completo los eventos cuando el foco
 * estaba sobre un input/textarea/select, así que un escaneo mientras el
